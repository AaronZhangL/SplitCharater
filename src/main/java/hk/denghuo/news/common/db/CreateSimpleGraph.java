 ...
 * 
 * @author Aaron.Z
 * @see https://github.com/neo4j/neo4j/blob/2.1.3/community/server-examples/src/main/java/org/neo4j/examples/server/CreateSimpleGraph.java
 * @see http://jersey.java.net/ 
 * @see http://repo1.maven.org/maven2/com/sun/jersey/jersey-client/1.9.1/
 */
public class CreateSimpleGraph {
	private static final String SERVER_ROOT_URI = "http://localhost/db/data/";
